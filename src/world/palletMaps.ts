  ...
  pallet_town: {
    ...
    warps: [
      ...
      { x: 16, y: 13, w: 1, h: 1, toMapId: "pallet_oak_lab", toX: 6, toY: 12, toLocation: "Pallet Town" },
      {
        ...
        w: 1,
        h: 1,
        toMapId: "viridian_forest",
        toX: 29,
        toY: 61,
        toLocation: "Viridian Forest",
        marker: { signTile: { x: 11, y: 3 }, direction: "north", label: "Forest" },
      },
    ],
    triggers: [],
  },
    ...
    warps: [
      {
        ...
        toX: 11,
        toY: 3,
        toLocation: "Pallet Town",
        marker: { signTile: { x: 29, y: 61 }, direction: "south", label: "Pallet" },
      },
    ],
    triggers: [],
  },
